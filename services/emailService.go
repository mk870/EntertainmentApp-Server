...
func emailForVerificationCodeHtml(firstName string, verificationCode string) string {
	return ("<h1>Hi " + firstName + "</h1> <p>Thank you for registering with <span style=\"color: rgb(9, 165, 165);font-size: 18px;font-weight:bold;\">Tube Max</span>. Please enter this code to activate your account: " + verificationCode + "</p></p> Link will expire in 15 minutes. See you soon</p>")
}
